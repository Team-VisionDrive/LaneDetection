...
class LaneDetection:
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/camera/rgb/image_raw/compressed/compressed", CompressedImage, self.image_topic_callback)
        ...
        self.WHITE_LANE_LOW_TH = np.array([0, 100, 0]) 
        self.WHITE_LANE_HIGH_TH = np.array([255, 255, 255])
